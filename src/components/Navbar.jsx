...
const Navbar = () => {
  const { activeMenu, setActiveMenu,
     isClicked, setIsClicked,
      ...
      // this is handling the screen sizes for the side bvar to open and close
      useEffect(() => {
    ...
    <div className='flex justify-between p-2 md:mx-6 relative'>
      ...
      <div className="flex">
        ...
        <NavButton title="Chat" customFunc={() => handleClick('chat')}
          dotColor="#03c9d7" icon={<BsChatLeft />} />

        <NavButton title="Notification" customFunc={() => handleClick('notification')}
          dotColor="blue" icon={<RiNotification3Line />} />
          ...
          >
            ...
            onClick={() => handleClick('userProfile')}>
              ...
              <MdKeyboardArrowDown className='txet-gray-400 text-14' />
            </div>
          </TooltipComponent>
          {isClicked.Cart && <Cart />}
          {isClicked.Chat && <Chat />}
